...
import { useDisplayProductQuery } from "@/app/redux/features/product/productApi";
...
import detail21JPG from "@/images/products/detail/detail3.webp";
import detail22JPG from "@/images/products/detail/detail3-1.webp";
import detail23JPG from "@/images/products/detail/detail3-2.webp";
import detail24JPG from "@/images/products/detail/detail3-4.webp";
import { ProductVariant, Product, Thumbnail, PRODUCTS } from "@/app/assets/data/data";
import IconDiscount from "@/app/assets/components/IconDiscount";
import NcInputNumber from "@/app/assets/components/NcInputNumber";
import BagIcon from "@/app/assets/components/BagIcon";
...
const ProductDetailPage2: FC<ProductDetailPage2Props> = ({
  ...
  const notifyAddTocart = () => {
    toast.custom(
      (t) => (
        <NotifyAddTocart
          productImage={cloudThumbnail && cloudThumbnail[0]}
        ...
        <header className="container mt-8 sm:mt-10">
          <div className="relative ">
            <div className="grid grid-cols-2 md:grid-cols-3 gap-3 lg:gap-6">
              ...
              >
                <div className="aspect-w-3 aspect-h-4 md:absolute md:inset-0">
                  {cloudThumbnail && <AdvancedImage
              ...
              {LIST_IMAGES_DEMO && LIST_IMAGES_DEMO.map((item, index) => {
                ...
                return (
                  ...
                  >
                    <div className="aspect-w-6 aspect-h-5 lg:aspect-h-4">
                      {cloudThumbnail && <AdvancedImage
                        className="object-scale-down w-full h-full rounded-md sm:rounded-xl"
                        cldImg={item}
                        alt={title}
