...
import NextPrev from "@/app/assets/shared/NextPrev/NextPrev";
import ButtonClose from "@/app/assets/shared/ButtonClose/ButtonClose";
      ...
      >
        ...
        >
          <ul className="glide__slides h-full ">
            {cloudImgs ? cloudImgs.map((item, index) => (
              <li className="glide__slide relative h-full" key={index}>
                <div className=" w-full h-full flex items-center justify-center ">
                  <AdvancedImage cldImg={item} alt="modal photos" className="object-scale-down max-w-full max-h-full rounded-2xl"  />
                </div>
              </li>
            )) : imgs.map((item, index) => (
              <li className="glide__slide relative h-full" key={index}>
