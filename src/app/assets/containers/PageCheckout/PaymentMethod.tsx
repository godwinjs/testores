        ...
        <div className="flex-1">
          ...
          >
            <div className="max-w-lg">
              ...
              <Input name="CNumber" displayName="CNumber" onChange={(e) => handleChange(e)} className="mt-1.5" type={"text"} />
            </div>
            <div className="max-w-lg">
              <Label className="text-sm">Name on Card</Label>
              <Input name="NOCard" displayName="NOCard" onChange={(e) => handleChange(e)} className="mt-1.5" />
            </div>
            <div className="flex flex-col sm:flex-row space-y-3 sm:space-y-0 sm:space-x-3">
              <div className="sm:w-2/3">
                <Label className="text-sm">Expiration date (MM/YY)</Label>
                <Input name="ExpDate" displayName="ExpDate" className="mt-1.5" onChange={(e) => handleChange(e)} placeholder="MM/YY" />
              </div>
              <div className="flex-1">
                <Label className="text-sm">CVC</Label>
                <Input name="CVC" displayName="CVC" className="mt-1.5" onChange={(e) => handleChange(e)} placeholder="CVC" />
              </div>
            </div>
            ...
            <div className="flex pt-6">
              ...
              <ButtonSecondary className="ml-3">
                clear
              </ButtonSecondary>
          </div>
          </div>
