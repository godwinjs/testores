...
const SectionHero: FC<SectionHeroProps> = ({ className = "", data }) => {

  const DATA: HeroDataType[] = data;
      ...
      >
        ...
        <div className="relative container pb-0 pt-14 sm:pt-20 lg:py-44">
          ...
          >
            ...
            <ButtonPrimary
              className="nc-SectionHero2Item__button group dark:bg-slate-900 transition duration-[2000ms] ease-in-out"
              sizeClass="py-3 px-6 sm:py-5 sm:px-9"
              href={item.btnLink as any}
            >
              <span>{item.btnText}</span>
              <span>
                <svg className="w-5 h-5 ml-2.5 group-hover:ml-5" viewBox="0 0 24 24" fill="none">
