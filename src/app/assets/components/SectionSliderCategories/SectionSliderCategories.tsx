...
import CardCategory2 from "@/app/assets/components/CardCategories/CardCategory2";
import department1Png from "@/images/collections/department/1.png";
import department2Png from "@/images/collections/department/2.png";
import department3Png from "@/images/collections/department/3.png";
import department4Png from "@/images/collections/department/4.png";

export interface CardCategoryData {
  name: string;
  desc: string;
  img: string | typeof department1Png;
  color?: string;
}
                ...
                <div>
                  <div className="absolute inset-y-6 inset-x-10 flex flex-col sm:items-center justify-center">
                    <div className="flex relative text-slate-900">
                      <span className="text-lg lg:text-xs xl:text-sm font-semibold ">
                        More collections
                      </span>
                      <svg
